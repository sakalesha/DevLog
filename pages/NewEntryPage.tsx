...
const NewEntryPage: React.FC = () => {
  ...
  useEffect(() => {
    if (id) {
      entryService.getEntryById(id).then(entry => {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-12 relative">
      ...
      {toast && (
        <div 
          className={`fixed top-6 right-6 z-[100] flex items-center gap-3 px-5 py-3 rounded-xl shadow-2xl animate-in slide-in-from-right-10 duration-300 border ${
            toast.type === 'success' 
